...
function brainLuck(code, input){
    let tape = new Array(3000).fill(0);
    ...
    while (i<code.length) {
      switch (code[i]) {
          ...
          case '-':
            ...
            break;
          case '.':
            result += String.fromCharCode(tape[head]);
            i++;
            break;
          case ',':
            tape[head] = input[inputIndex].charCodeAt(0);
            inputIndex++;
            i++;
            break;
          case '[':
      ...
      //console.log(i, result, input, inputIndex, tape[head]);
    }
